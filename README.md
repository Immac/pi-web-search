...
- Check the [Architecture Documentation](ARHITECTURE.md) for design details
- Open an issue on [GitHub Issues](https://github.com/Immac/pi-web-search/issues)
- Review the skill file: `SKILL.md`
...
- [Lightpanda](https://github.com/lightpanda-io/browser) - Fast, lightweight browser for automation
- [Playwright](https://playwright.dev/) - Reliable browser automation
- [Pi Coding Agent](https://github.com/mariozechner/pi-coding-agent) - The pi extension framework
- [Touhou Project](https://en.wikipedia.org/wiki/Touhou_Project) - For inspiration (and testing! 😊)
